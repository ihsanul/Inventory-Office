                ...
                <div class="col-md-12">
                    <div class="navbar-collapse">
                        <ul id="menu-top" class="nav navbar-nav navbar-left topnav">
                            ...
                            <li><a class="menu-top-active" href="lokasi.php">Lokasi Barang</a></li>
                        ...
                        <div class="panel panel-default">
                          ...
                          <div class="row">
                            <div class="col-md-12 text-right">
                              <button class="btn btn-primary btn-success" data-toggle="modal" data-target="#modalForm"><i class="fa fa-plus-circle"></i> Tambah Lokasi Barang</button>
                            </div></br></br>
                          </div>
                            <div class="row">
                              <div class="table-responsive">
                                <table id="example" class="table table-striped table-bordered display">
                                    <thead>
                                      <tr>
                                        <th style="max-width: 15px;">No &nbsp&nbsp</th>
                                        <th>Lokasi</th>
                                    ...
                                    <?php
                                     include '../koneksi.php';
                                     $query = mysqli_query($koneksi, "SELECT * FROM tb_lokasi WHERE ket_lokasi='true'");
                                     $no=1;
                                     while($row = mysqli_fetch_array($query)) {
                                        ...
                                        echo '<td>
                                          <button class="btn btn-primary btn-disable" data-toggle="modal" data-target="#modalFormedit" name="edit" data-id="'.$row['id_lokasi'].'"><i class="fa fa-pencil"></i> Edit</button>
                                          <button class="btn btn-primary btn-danger hapus" data-toggle="modal" data-target="#modalhapus" name="hapus" data-id="'.$row['id_lokasi'].'"><i class="fa fa-eraser"></i> Hapus</button>  
                                        </td>';
                                        echo '</tr>';
                                        $no++;
                                     }
                         ...
                         <script>
                                    ...
                                    $(function(){
                                      ...
                                      e.preventDefault();
                                      if (document.tambah_form.lokasi.value == "") {alert("Isikan Nama Lokasi!");}
                                      else{
                                      var Data = $("#tambah_form").serialize();
                                      $.ajax({
                                              url: "lokasi_simpan.php",
                                              type: "POST",
                                              data: Data,
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="labelModalKu">Tambah Lokasi Barang Form</h4>
                </div>
                <!-- Modal Body -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="labelModalKu">Edit Lokasi Barang Form</h4>
                </div>
                <!-- Modal Body -->
                <div class="modal-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="labelModalKu">Hapus Lokasi Barang</h4>
                </div>
                <!-- Modal Body -->
                <div class="modal-body">
                     <label>Apakah anda yakin menghapus lokasi barang ?</label>
