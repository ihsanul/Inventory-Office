                        ...
                        <!--   <div class="row">
                                    ...
                                    <?php
                                     ...
                                     while($row = mysqli_fetch_array($query)) {
                                        ...
                                        if($row['status']=="Belum ditanggapi"){
                                          echo '<button class="btn btn-primary btn-disable" data-toggle="modal" data-target="#modalterima" name="terima" data-id="'.$row['id_wish'].'"><i class="fa fa-check-circle"></i> Terima</button>
                                          <button class="btn btn-primary btn-danger hapus" data-toggle="modal" data-target="#modaltolak" name="tolak" data-id="'.$row['id_wish'].'"><i class="fa fa-times-circle"></i> Tolak</button>';}
                                          else  {echo "";}
                                        echo '</td>';
                                        echo '</tr>';
                                        $no++;
                         ...
                         <script>
                                    ...
                                    $(function(){
                                      ...
                                      e.preventDefault();
                                      var Data = $("#terima_form").serialize();
                                      $.ajax({
                                              url: "wishlist_terima.php",
                                              type: "POST",
                                              data: Data,
                                        ...
                                        $('#modalterima').on('show.bs.modal', function (e) {
                                          var rowid = $(e.relatedTarget).data('id');
                                          //menggunakan fungsi ajax untuk pengambilan data
                                          $.ajax({
                                              type : 'POST',
                                              url : 'wishlist_terimamodal.php',
                                              data :  'rowid='+ rowid,
                                          ...
                                          $('.submitBtn2').click(function tolak(e){
                                            e.preventDefault();
                                              var Data = $("#tolak_form").serialize();
                                              // var tom = $(this).attr(
                                            $.ajax({
                                                    url: "wishlist_tolak.php",
                                                    type: "POST",
                                                    data: Data,
                                                    success: function(msg){
                                                    alert(msg);
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="labelModalKu">Terima Wish</h4>
                </div>
                <!-- Modal Body -->
                <div class="modal-body">
                  <label>Apakah anda yakin menerima wish ?</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="labelModalKu">Tolak Wish</h4>
                </div>
                <!-- Modal Body -->
                <div class="modal-body">
                     <label>Apakah anda yakin menolak wish ?</label>
